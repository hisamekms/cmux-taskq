...
use crate::{
    ...
    infrastructure::{
        adapters::{
            ClaudeCode, GitRepository, claude_trusts_repository, inbox_workspace_name, path_text,
            planner_workspace_name, shell_join, supervisor_workspace_name, workspace_description,
